...
double Fator_Correcao(int erro, double velMarker)
{
    ...
    {
        double resp = velMarker - (velMarker-1)*exp(-k*erro);
        return abs(resp);
    }
}
...
//////////////////////////////////////////////////////////// FIM FUNÇÃO CORREÇÃO //////////////////////////////////////////////
//////////////////////////////////////////////////////////// INICIO FUNÇÃO VELOCIDADE /////////////////////////////////////////
double Target_Velocity(double tempX, double tempAntX, double tempY, double tempAntY, double t)
{
    cout << "tempo" << t << endl;
    double vx,vy;
    vx = (tempX-tempAntX)/t;
    vy = (tempY-tempAntY)/t;
    double velMarker = sqrt(vx*vx+vy*vy);
    cout<<"velocidade" << velMarker<<endl;
    return velMarker;
}

//////////////////////////////////////////////////////////// FIM FUNÇÃO VELOCIDADE //////////////////////////////////////////////
...
int main(int argc, char **argv)
{
    ...
    double tempX=0, tempY=0, tempZ=0, auxX=0, auxY=0, tempAntX=0,tempAntY=0,tempAntZ=0;
   ...
   // string nome("/home/odroid/catkin_ws/src/vant/LOGS_Vision2/"); // Para o Odroid
    ...
    { 					//ORIGINALMENTE N TINHA NDA MULTIPLICANDO tolZ
        iteracoes = iteracoes+1;
        timeval velTimeOld;
        gettimeofday(&velTimeOld, NULL);
...
//            /vVelInertial.setValue(0,0,offsetZ);
         ...
         if(eye.getPoseAlvar().id == 1)
         {
            ...
            timeval velTimeNew;
            gettimeofday(&velTimeNew, NULL);
            double tempo = double(velTimeNew.tv_sec -velTimeOld.tv_sec)+double(velTimeNew.tv_usec-velTimeOld.tv_usec)*1.e-6;
            cout<<"TEMPO TEMPO TEMPO"<< tempo<<endl;
            double velMarker = Target_Velocity(tempX,tempAntX,tempY,tempAntY,tempo);


            double prcentVY = FuzzyTipo2VY (auxX,auxY);
            Ky = Fator_Correcao(abs(auxY),velMarker);
            //Ky =amp;
            ...
            //Kx =amp;
            Kx = Fator_Correcao(abs(auxX),velMarker);
            //Kz=1;
            Kz = BoostZ(abs(tempZ));
