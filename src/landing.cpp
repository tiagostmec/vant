...
float gainX = 0.019,
      ...
      offsetZ = 0,
      vFinal = -0.5,
      tolZ = 1;     // Limite pra considerar que pousou riginal tolZ=0.1
			

// Fuzzy things

ofstream debugFuzzyParameters, debugPosition, debugPositionArPose, debugTimeToProc;                         // para gerar o LOG;
...
int main(int argc, char **argv)
{
    ...
    double tempX, tempY, tempZ, auxX, auxY;

    string nome("/home/litel/catkin_ws/src/vant/LOGS/"); // Para o PC
