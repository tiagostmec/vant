...
////SkyPat////
#include <unistd.h>
#include </home/laic/catkin_ws/src/vant/include/skypat/skypat.h>
...
//variáveis dentro da função Calcula_PID
...
//            /vVelInertial.setValue(0,0,offsetZ);
         ...
         if(eye.getPoseAlvar().id == 1){
            ...
            //CHAMADA DO Calcula_PID
            cout << "funçao VY" << endl;
            double resultVY = Calcula_PID(tempY,tempYprev);
            cout << "funçao VZ" << endl;
            double resultVZ = Calcula_PID(tempZ,tempZprev);
            cout << "funçao VX" << endl;
            double resultVX = Calcula_PID(tempX,tempXprev);
    ...
    //Realiza os testes do skypat usando o RunAll(), não há necessidade de colocar argumentos para os testes
